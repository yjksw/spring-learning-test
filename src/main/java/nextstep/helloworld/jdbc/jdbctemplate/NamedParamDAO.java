...
public class NamedParamDAO {
    ...
    public int useMapSqlParameterSource(String firstName) {
        ...
        SqlParameterSource namedParams = new MapSqlParameterSource("first_name", firstName);
        return this.namedParameterJdbcTemplate.queryForObject(sql, namedParams, Integer.class);
    }
    ...
    public int useBeanPropertySqlParameterSource(Customer customer) {
        ...
        SqlParameterSource namedParams = new BeanPropertySqlParameterSource(customer);
        return this.namedParameterJdbcTemplate.queryForObject(sql, namedParams, Integer.class);
    }
}
